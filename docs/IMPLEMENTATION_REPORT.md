...
| Source files / LOC (excl. tests) | 129 files, ~22,900 LOC                    |
| Test files / LOC                 | 165 files, ~33,300 LOC                    |
| Full test run                    | 165 files, 785 passed, 1 skipped, 0 failed|
| Line coverage                    | 85.17%                                    |
...
| Full test suite             | `npm test`                 | PASS — 165 files, 785 passed / 1 skipped        |
| Coverage gate (≥80% lines)  | `npm run test:coverage`    | PASS — 85.17% lines                             |
