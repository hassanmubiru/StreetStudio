...
| Source files / LOC (excl. tests) | 168 files, ~26,095 LOC                    |
| Test files / LOC                 | 183 files, ~35,465 LOC                    |
| Full test run (with a DB)        | 183 files, 879 passed, 0 skipped, 0 failed|
| Line coverage                    | 86.13% (DB-backed) / ~82% (no-DB)         |
