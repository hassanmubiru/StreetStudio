...
| Test files / LOC                 | 177 files, ~34,700 LOC                    |
| Full test run (with a DB)        | 177 files, 860 passed, 0 skipped, 0 failed|
...
| Full test suite             | `npm test`                 | PASS — 176 files, 858 passed / 0 skipped (DB-backed) |
