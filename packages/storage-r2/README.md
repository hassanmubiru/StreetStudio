...
Cloudflare R2 storage provider delivered as an isolated plugin (Requirement
9.2). R2 is S3-compatible, so this package reuses the S3-style implementation
from `@streetstudio/storage-s3`, parameterized by the R2 account endpoint.
