...
De-seam remaining pkgs → StreetJS ███░░░░░░░  30%   recordings/uploads/playback/identity real; auth: step 1 (real Postgres stores) + real AuthService verified end-to-end on them (ADR-0020)
...
| Test LOC            | 34,486 |
| Tests               | 855 passing with a DB (integration tests skip without one) |
| Line coverage       | 86.02% (DB-backed, as CI runs); ~82% no-DB local |
