...
| Test LOC            | 36,053 |
| Tests               | 891 passing with a DB (integration tests skip without one) |
| Line coverage       | 86.35% (DB-backed, as CI runs); ~82% no-DB local |
...
- **`@streetstudio/recordings`, `@streetstudio/uploads`, and
  ...
  Measured: with a DB line coverage is **86.35%**; without a DB (integration
