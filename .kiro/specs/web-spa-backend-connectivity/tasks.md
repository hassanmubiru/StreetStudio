...
- [x] 5. Slice 3 — Root-path correctness
  ...
  - [x] 5.2 Verify Slice 3 via the per-slice verification loop
...
- [x] 6. Slice 4 — SDK adoption (login vertical first)
  ...
  - [x] 6.3 Route the login vertical through the SDK; use `useBearerToken` for dynamic tokens
